...
QFlacCodec* QFlacCodec::callbackObject = NULL;
...
int QFlacCodec::encode(const qint8 input[], int inputSize, qint8 output[], int outputSize)
{
	mCurrentBuffer = output;
}

int QFlacCodec::encode(const qint16 input[], int inputSize, qint8 output[], int outputSize)
{
	mCurrentBuffer = output;
}

int QFlacCodec::encode(const qint32 input[], int inputSize, qint8 output[], int outputSize)
{
	mCurrentBuffer = output;
}
