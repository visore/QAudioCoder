...
IF(${DISTRO} MATCHES "Debian")
 ...
 ${LONG_DESCRIPTION}
Homepage: ${HOMEPAGE}")
	SET(CPACK_DEBIAN_PACKAGE_DEPENDS "libQt${QT_VERSION_MAJOR}Core (>= 5.0.0), libQt${QT_VERSION_MAJOR}Multimedia (>= 5.0.0)")
ELSEIF(${DISTRO} MATCHES "Redhat")
	SET(CPACK_RPM_PACKAGE_PROVIDES "libqaudiocoder.so")
	...
	${LONG_DESCRIPTION}")
	set(CPACK_RPM_PACKAGE_REQUIRES "libQtCore.so >= 5.0.0")
ENDIF()
#############################################################################################
